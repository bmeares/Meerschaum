...
GRAFANA_RESOURCES_PATH = Path(os.path.join(CONFIG_ROOT_PATH, 'config', 'stack', 'grafana', 'resources'))
...
STACK_RESOURCES_PATH = Path(os.path.join(CONFIG_ROOT_PATH, 'config', 'stack', 'resources'))
